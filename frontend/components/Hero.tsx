    ...
    <section className="relative py-20 px-4">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button size="lg" asChild className="text-lg px-8 bg-cta text-white hover:bg-orange-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
          {[
            { icon: PenTool, title: "Easy Writing", text: "Intuitive editor with rich formatting options" },
            { icon: Users, title: "Community", text: "Connect with writers and readers worldwide" },
            { icon: BookOpen, title: "Discover", text: "Find amazing stories across all topics" },
